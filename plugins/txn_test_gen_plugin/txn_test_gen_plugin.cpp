 ...
 */
#include <betterchain/txn_test_gen_plugin/txn_test_gen_plugin.hpp>
...
FC_REFLECT(betterchain::detail::txn_test_gen_empty, );
...
#define INVOKE_V_R_R(api_handle, call_name, in_param0, in_param1) \
     ...
     betterchain::detail::txn_test_gen_empty result;
...
struct txn_test_gen_plugin_impl {
   void create_test_accounts(const std::string& init_name, const std::string& init_priv_key) {
      ...
      //create "A" account
      {
      auto owner_auth   = betterchain::chain::authority{1, {{txn_text_receiver_A_pub_key, 1}}, {}};
      auto active_auth  = betterchain::chain::authority{1, {{txn_text_receiver_A_pub_key, 1}}, {}};
      ...
      //create "B" account
      {
      auto owner_auth   = betterchain::chain::authority{1, {{txn_text_receiver_B_pub_key, 1}}, {}};
      auto active_auth  = betterchain::chain::authority{1, {{txn_text_receiver_B_pub_key, 1}}, {}};
      auto recovery_auth = betterchain::chain::authority{1, {}, {{{creator, "active"}, 1}}};
