...
CHAINBASE_SET_INDEX_TYPE( betterchain::public_key_history_object, betterchain::public_key_history_multi_index )

FC_REFLECT( betterchain::public_key_history_object, (public_key)(name)(permission) )
