...
CHAINBASE_SET_INDEX_TYPE( betterchain::transaction_history_object, betterchain::transaction_history_multi_index )

FC_REFLECT( betterchain::transaction_history_object, (block_id)(transaction_id)(transaction_status) )
