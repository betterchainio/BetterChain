...
CHAINBASE_SET_INDEX_TYPE( betterchain::account_control_history_object, betterchain::account_control_history_multi_index )

FC_REFLECT( betterchain::account_control_history_object, (controlled_account)(controlled_permission)(controlling_account) )
