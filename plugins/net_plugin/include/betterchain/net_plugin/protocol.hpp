...
#include <betterchain/net_plugin/protocol.hpp>
#include <chrono>
...
FC_REFLECT( betterchain::select_ids<fc::sha256>, (mode)(pending)(ids) )
FC_REFLECT( betterchain::handshake_message,
            (network_version)(chain_id)(node_id)(key)
            (time)(token)(sig)(p2p_address)
            (last_irreversible_block_num)(last_irreversible_block_id)
            (head_num)(head_id)
            (os)(agent)(generation) )
FC_REFLECT( betterchain::go_away_message, (reason)(node_id) )
FC_REFLECT( betterchain::time_message, (org)(rec)(xmt)(dst) )
#if 0 //disabling block summary support
FC_REFLECT( betterchain::processed_trans_summary, (id)(outmsgs) )
FC_REFLECT( betterchain::thread_ids, (gen_trx)(user_trx) )
#endif
FC_REFLECT( betterchain::block_summary_message, (block_header)/*(trx_ids)*/ )
FC_REFLECT( betterchain::notice_message, (known_trx)(known_blocks) )
FC_REFLECT( betterchain::request_message, (req_trx)(req_blocks) )
FC_REFLECT( betterchain::sync_request_message, (start_block)(end_block) )
