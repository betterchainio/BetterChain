...
namespace betterchain {
  ...
  using betterchain::chain::transaction_id_type;
  ...
  void net_plugin::set_program_options( options_description& /*cli*/, options_description& cfg )
  {
    cfg.add_options()
     ...
     ( "agent-name", bpo::value<string>()->default_value("\"BetterChain Test Agent\""), "The name supplied to identify this node amongst the peers.")
