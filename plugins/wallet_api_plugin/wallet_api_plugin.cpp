 ...
 */
#include <betterchain/wallet_api_plugin/wallet_api_plugin.hpp>
...
FC_REFLECT(betterchain::detail::wallet_api_plugin_empty, );
...
#define INVOKE_V_R(api_handle, call_name, in_param) \
     ...
     betterchain::detail::wallet_api_plugin_empty result;
