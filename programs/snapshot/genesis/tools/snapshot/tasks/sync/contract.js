        ...
        if(transfers.length) {
          transfers.forEach( transfer => {
            request.push({
              ...
              bbc_amount:   new bn(transfer.returnValues.value).toFixed()
            })
          })
        ...
        if(claims.length) {
          claims.forEach( claim => {
            request.push({
                ...
                bbc_amount:   new bn(claim.returnValues.amount).toFixed()
              })
          })
        ...
        if(registrations.length) {
          registrations.forEach( registration => {
            request.push({
              ...
              bbc_key:      registration.returnValues.key
            })
          })
