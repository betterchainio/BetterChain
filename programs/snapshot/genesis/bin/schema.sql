...
CREATE TABLE `claims` (
  ...
  `period` int(11) NOT NULL,
  `bbc_amount` decimal(65,0) NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`),
  KEY `INDEXADDRESS` (`address`),
  KEY `INDEXBN` (`block_number`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
CREATE TABLE `keys` (
  ...
  `derived_bbc_key` varchar(256) NOT NULL DEFAULT '',
  PRIMARY KEY (`id`),
...
CREATE TABLE `registrations` (
  ...
  `block_number` int(255) NOT NULL,
  `address` varchar(256) NOT NULL,
  `bbc_key` varchar(256) DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `INDEXADDRESS` (`address`),
  KEY `INDEXBN` (`block_number`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
