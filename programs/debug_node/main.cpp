 ...
 */
#include <betterchain/app/application.hpp>

#include <betterchain/debug_producer/debug_producer.hpp>
...
int main(int argc, char** argv) {
   ...
   try {
      bpo::options_description app_options("BetterChain Producer Node");
      bpo::options_description cfg_options("BetterChain Producer Node");
