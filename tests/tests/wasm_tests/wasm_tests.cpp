...
{ try {
      ...
      {
         betterchain::chain::signed_transaction txn;
         txn.scope = {"currency"};
         txn.messages.resize(1);
         txn.messages[0].code = config::betterchain_contract_name;
      ...
      betterchain::chain::signed_transaction txn2;
...
{ try {
   ...
   betterchain::chain::signed_transaction txn3;
   ...
   betterchain::chain::signed_transaction txn4;
   ...
   betterchain::chain::signed_transaction txn11;
   ...
   betterchain::chain::signed_transaction txn12;
   ...
   betterchain::chain::signed_transaction txn13;
   ...
   betterchain::chain::signed_transaction txn14;
   ...
   betterchain::chain::signed_transaction txn15;
   ...
   betterchain::chain::signed_transaction txn21;
   ...
   betterchain::chain::signed_transaction txn22;
   ...
   betterchain::chain::signed_transaction txn23;
   ...
   betterchain::chain::signed_transaction txn24;
   ...
   betterchain::chain::signed_transaction txn25;
