...
#include <betterchain/wallet_plugin/wallet.hpp>
#include <betterchain/wallet_plugin/wallet_manager.hpp>
...
{ try {
   using namespace betterchain::wallet;
...
#warning TODO: fix check commented out when keys was converted to map<public_key_type,string> 
   ...
   transaction_emplace_message(trx,config::betterchain_contract_name, vector<types::account_permission>{{sender,"active"}}, "transfer",
