...
#include <betterchain/abi_generator/abi_generator.hpp>

using namespace betterchain;
...
{ try {
  ...
  if( std::getenv("BetterChainLIB") == nullptr ) {
    wlog("*************************************");
    wlog("*  BetterChainLIB env variable not defined  *");
    wlog("*  ABIGenerator tests will not run  *");
    wlog("*************************************");
    return;
  }

  auto is_abi_generation_exception =[](const betterchain::abi_generation_exception& e) -> bool { return true; };

  auto generate_abi = [this](const char* source, const char* abi, bool opt_sfs=false) -> bool {

    const char* lib_path = std::getenv("BetterChainLIB");
    FC_ASSERT(lib_path != NULL);

    std::string include_param = std::string("-I") + lib_path;
   ...
   BOOST_CHECK_EXCEPTION( generate_abi(unknown_type, ""), betterchain::abi_generation_exception, is_abi_generation_exception );
   ...
   struct test_struct {
      ...
      action_name             field26;
      scope_name              field27;
      permission_level        field28;
      action                  field29;
      permission_level_weight field30;
      transaction             field31;
      signed_transaction      field32;
      key_weight              field33;
      authority               field34;
      chain_config            field35;
      type_def                field36;
      action_def              field37;
      table_def               field38;
      abi_def                 field39;
   ...
   BOOST_CHECK_EXCEPTION( generate_abi(double_base, ""), betterchain::abi_generation_exception, is_abi_generation_exception );
   ...
   BOOST_CHECK_EXCEPTION( generate_abi(unable_to_determine_index, ""), betterchain::abi_generation_exception, is_abi_generation_exception );
  ...
  // typedef fixed_string16 FieldName;
   ...
   BOOST_CHECK_EXCEPTION( generate_abi(long_field_name, ""), betterchain::abi_generation_exception, is_abi_generation_exception );
   ...
   BOOST_CHECK_EXCEPTION( generate_abi(long_type_name, "{}"), betterchain::abi_generation_exception, is_abi_generation_exception );
   ...
   BOOST_CHECK_EXCEPTION( generate_abi(same_type_different_namespace, ""), betterchain::abi_generation_exception, is_abi_generation_exception );
   ...
   BOOST_CHECK_EXCEPTION( generate_abi(bad_index_type, ""), betterchain::abi_generation_exception, is_abi_generation_exception );
   ...
   BOOST_CHECK_EXCEPTION( generate_abi(union_table, ""), betterchain::abi_generation_exception, is_abi_generation_exception );
   ...
   BOOST_CHECK_EXCEPTION( generate_abi(same_action_different_type, ""), betterchain::abi_generation_exception, is_abi_generation_exception );
...
{ try {
   ...
   const char *my_other = R"=====(
    {
      "publickey"     :  "BetterChain6MRyAjQq8ud7hVNYcfnVPJqcVpscN5So8BhtHuGYqET5GDW5CV",
      "publickey_arr" :  ["BetterChain6MRyAjQq8ud7hVNYcfnVPJqcVpscN5So8BhtHuGYqET5GDW5CV","BetterChain6MRyAjQq8ud7hVNYcfnVPJqcVpscN5So8BhtHuGYqET5GDW5CV","BetterChain6MRyAjQq8ud7hVNYcfnVPJqcVpscN5So8BhtHuGYqET5GDW5CV"],
      "asset"         : "100.00 BetterChain",
      "asset_arr"     : ["100.00 BetterChain","100.00 BetterChain"],
      "price"         : { "base" : "100.00 BetterChain", "quote" : "200.00 BTC" },
      "price_arr"     : [{ "base" : "100.00 BetterChain", "quote" : "200.00 BTC" },{ "base" : "100.00 BetterChain", "quote" : "200.00 BTC" }],

      "string"            : "ola ke ase",
      "string_arr"        : ["ola ke ase","ola ke desi"],
      "time"              : "2021-12-20T15:30",
      "time_arr"          : ["2021-12-20T15:30","2021-12-20T15:31"],
      "signature"         : "BetterChainJzdpi5RCzHLGsQbpGhndXBzcFs8vT5LHAtWLMxPzBdwRHSmJkcCdVu6oqPUQn1hbGUdErHvxtdSTS1YA73BThQFwT77X1U",
      "signature_arr"     : ["BetterChainJzdpi5RCzHLGsQbpGhndXBzcFs8vT5LHAtWLMxPzBdwRHSmJkcCdVu6oqPUQn1hbGUdErHvxtdSTS1YA73BThQFwT77X1U","BetterChainJzdpi5RCzHLGsQbpGhndXBzcFs8vT5LHAtWLMxPzBdwRHSmJkcCdVu6oqPUQn1hbGUdErHvxtdSTS1YA73BThQFwT77X1U"],
      ...
      "strx": {
        ...
        "read_scope":["acc1"],
        "write_scope":["acc1"],
        "signatures" : ["BetterChainJzdpi5RCzHLGsQbpGhndXBzcFs8vT5LHAtWLMxPzBdwRHSmJkcCdVu6oqPUQn1hbGUdErHvxtdSTS1YA73BThQFwT77X1U"],
        "actions":[{"scope":"scopename1", "name":"actionname1", "authorization":[{"actor":"acc1","permission":"permname1"}], "data":"445566"}]
      },
      "strx_arr": [{
        "ref_block_num":"1",
      ...
      "keyweight": {"key":"BetterChain6MRyAjQq8ud7hVNYcfnVPJqcVpscN5So8BhtHuGYqET5GDW5CV", "weight":"100"},
      "keyweight_arr": [{"key":"BetterChain6MRyAjQq8ud7hVNYcfnVPJqcVpscN5So8BhtHuGYqET5GDW5CV", "weight":"100"},{"key":"BetterChain6MRyAjQq8ud7hVNYcfnVPJqcVpscN5So8BhtHuGYqET5GDW5CV", "weight":"200"}],
      "authority": {
         "threshold":"10",
         "keys":[{"key":"BetterChain6MRyAjQq8ud7hVNYcfnVPJqcVpscN5So8BhtHuGYqET5GDW5CV", "weight":"100"},{"key":"BetterChain6MRyAjQq8ud7hVNYcfnVPJqcVpscN5So8BhtHuGYqET5GDW5CV", "weight":"200"}],
...
{ try {
   ...
   abi_serializer abis(chain_initializer::betterchain_contract_abi());
...
{ try {
   ...
   {
     "name" : "acct.name",
     "key" : "BetterChain5PnYq6BZn7H9GvL68cCLjWUZThRemTJoJmybCn1iEpVUXLb5Az",
     "configuration" : {
   ...
   BOOST_TEST("BetterChain5PnYq6BZn7H9GvL68cCLjWUZThRemTJoJmybCn1iEpVUXLb5Az" == (string)setproducer.key);
...
{ try {
   ...
   const char* test_data = R"=====(
   {
     ...
     "data" : {
        ...
        "keys" : [ {"key" : "BetterChain65rXebLhtk2aTTzP4e9x1AQZs7c5NNXJp89W8R3HyaA6Zyd4im", "weight" : 57005},
                   {"key" : "BetterChain5eVr9TVnqwnUBNwf9kwMTbrHvX5aPyyEG97dz2b2TNeqWRzbJf", "weight" : 57605} ],
   ...
   BOOST_TEST("BetterChain65rXebLhtk2aTTzP4e9x1AQZs7c5NNXJp89W8R3HyaA6Zyd4im" == (std::string)updateauth.data.keys[0].key);
   BOOST_TEST(57005u == updateauth.data.keys[0].weight);
   BOOST_TEST("BetterChain5eVr9TVnqwnUBNwf9kwMTbrHvX5aPyyEG97dz2b2TNeqWRzbJf" == (std::string)updateauth.data.keys[1].key);
...
{ try {
   ...
   const char* test_data = R"=====(
   {
     ...
     "deposit" : "-90000000.0000 BetterChain"
   }
   )=====";
   ...
   BOOST_TEST("BetterChain65rXebLhtk2aTTzP4e9x1AQZs7c5NNXJp89W8R3HyaA6Zyd4im" == (std::string)newaccount.owner.keys[0].key);
   BOOST_TEST(57005u == newaccount.owner.keys[0].weight);
   BOOST_TEST("BetterChain5eVr9TVnqwnUBNwf9kwMTbrHvX5aPyyEG97dz2b2TNeqWRzbJf" == (std::string)newaccount.owner.keys[1].key);
   ...
   BOOST_TEST("BetterChain65rXebLhtk2aTTzP4e9x1AQZs7c5NNXJp89W8R3HyaA6Zyd4im" == (std::string)newaccount.active.keys[0].key);
   BOOST_TEST(57005u == newaccount.active.keys[0].weight);
   BOOST_TEST("BetterChain5eVr9TVnqwnUBNwf9kwMTbrHvX5aPyyEG97dz2b2TNeqWRzbJf" == (std::string)newaccount.active.keys[1].key);
   ...
   BOOST_TEST("BetterChain65rXebLhtk2aTTzP4e9x1AQZs7c5NNXJp89W8R3HyaA6Zyd4im" == (std::string)newaccount.recovery.keys[0].key);
   BOOST_TEST(57005u == newaccount.recovery.keys[0].weight);
   BOOST_TEST("BetterChain5eVr9TVnqwnUBNwf9kwMTbrHvX5aPyyEG97dz2b2TNeqWRzbJf" == (std::string)newaccount.recovery.keys[1].key);
   ...
   BOOST_TEST(BETTERCHAIN_SYMBOL == newaccount.deposit.symbol);
...
{ try {
   ...
   BOOST_TEST("BetterChain65rXebLhtk2aTTzP4e9x1AQZs7c5NNXJp89W8R3HyaA6Zyd4im" == (std::string)postrecovery.data.keys[0].key);
