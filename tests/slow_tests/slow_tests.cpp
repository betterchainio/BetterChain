...
{ try {
      ...
      Make_Blockchain(chain, ::betterchain::chain_plugin::default_transaction_execution_time,
            ::betterchain::chain_plugin::default_received_block_transaction_execution_time,
            ::betterchain::chain_plugin::default_create_block_transaction_execution_time, rate_limit);
...
{ try {
...

      {
         ...
         catch (const betterchain::chain::checktime_exceeded& check)
         {
