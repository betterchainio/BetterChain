...
extern "C" {
    ...
    void test_extended_memory()
    {
       ...
       ptr1_realloc = (char*)betterchain::realloc(ptr1, 10);
       ...
       ptr1_realloc = (char*)betterchain::realloc(ptr1, 13);
       ...
       ptr1 = ptr1_realloc;
       ptr1_realloc = (char*)betterchain::realloc(ptr1, 972);
       ...
       char* ptr5 = (char*)betterchain::malloc(1020);
       ...
       char* ptr6 = (char*)betterchain::malloc(996);
