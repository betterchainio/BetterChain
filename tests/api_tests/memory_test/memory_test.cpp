...
extern "C" {
    ...
    void print(const void* const ptr, const uint32_t size)
    {
       ...
       for (uint32_t i = 0; i < size; ++i)
       {
          ...
          betterchain::print("", static_cast<uint32_t>(static_cast<unsigned char>(char_ptr[i])), delim);
       }
       betterchain::print("}\n");
    }
    ...
    void test_memory()
    {
       ...
       char* ptr1_realloc = (char*)betterchain::realloc(ptr1, 30);
       ...
       // 20 chars allocated
       char* ptr2 = (char*)betterchain::malloc(20);
       ...
       ptr1_realloc = (char*)betterchain::realloc(ptr1, 15);
       ...
       ptr1_realloc = (char*)betterchain::realloc(ptr1, 30);
       assert(ptr1_realloc != nullptr, "should have returned a 30 char buf");
       ...
       ptr1_realloc = (char*)betterchain::realloc(ptr1, 36);
       ...
       ptr1_realloc = (char*)betterchain::realloc(ptr1, 37);
       ...
       char* nullptr_realloc = (char*)betterchain::realloc(nullptr, 50);
       ...
       char* invalid_ptr_realloc = (char*)betterchain::realloc(nullptr_realloc + 4, 10);
    ...
    void test_memory_hunk()
    {
       ...
       char* ptr1 = (char*)betterchain::malloc(15 * 64 * 1024 - 4);
    ...
    void test_memory_hunks()
    {
       ...
       char* ptr1 = (char*)betterchain::malloc(7404);
       ...
       for (int i = 0; i < 96; ++i)
       {
          char* ptr2 =  (char*)betterchain::malloc(10 * 1024 - 15);
       ...
       char* ptr3 =  (char*)betterchain::malloc(765);
       ...
       // use all but 8 chars
       char* ptr4 = (char*)betterchain::malloc(764);
       ...
       char* ptr5 = (char*)betterchain::malloc(4);
       ...
       char* ptr6 = (char*)betterchain::malloc(4);
    ...
    void test_memory_hunks_disjoint()
    {
       ...
       char* ptr1 = (char*)betterchain::malloc(8 * 1024 - 12);
       ...
       for (int i = 0; i < 14; ++i)
       {
          ...
          loop_ptr1[i] = (char*)betterchain::malloc(64 * 1024 - 28);
       ...
       char* ptr2 = (char*)betterchain::malloc(65412);
       ...
       for (int i = 0; i < 14; ++i)
       {
          ...
          loop_ptr2[i] = (char*)betterchain::malloc(12);
       ...
       char* ptr3 = (char*)betterchain::malloc(4);
       ...
       char* ptr4 = (char*)betterchain::malloc(4);
       ...
       for (int i = 0; i < 13; ++i)
       {
          ...
          loop_ptr3[i] = (char*)betterchain::malloc(4);
       ...
       betterchain::free(loop_ptr1[3]);
       betterchain::free(loop_ptr2[3]);
       betterchain::free(loop_ptr3[3]);

       char* slot3_ptr[64];
       for (int i = 0; i < 64; ++i)
       {
          slot3_ptr[i] = (char*)betterchain::malloc(1020);
       ...
       char* ptr7 = (char*)betterchain::malloc(4);
