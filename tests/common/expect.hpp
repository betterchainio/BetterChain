...
namespace betterchain { namespace test {
...
#define EXPECT_3(P, E, T) betterchain::test::expect<P>(E,T,"EXPECT<" #P ">(" #E "," #T ")")
#define EXPECT_2(E, T) betterchain::test::expect(E,T,"EXPECT(" #E "," #T ")")
#define EXPECT_1(E) betterchain::test::expect(E,"EXPECT(" #E ")")
