 ...
 *
 * @code{.cpp}
 * // Link alice's "money" authority with betterchain::transfer
 * Link_Authority(chain, alice, "money", betterchain, "transfer");
 * // Set alice's "native" authority as default for betterchain contract
 * Link_Authority(chain, alice, "money", betterchain);
 * @endcode
 */
 ...
 *
 * @code{.cpp}
 * // Unlink alice's authority for betterchain::transfer
 * Unlink_Authority(chain, alice, betterchain, "transfer");
 * // Unset alice's default authority for betterchain contract
 * Unlink_Authority(chain, alice, betterchain);
 * @endcode
 */
 ...
 * @code{.cpp}
 * // Send 10 BetterChain from alice to bob
 * Transfer_Asset(chain, alice, bob, asset(10));
 *
 * // Send 10 BetterChain from alice to bob with memo "Thanks for all the fish!"
 ...
 * @code{.cpp}
 * // Convert 10 of bob's BetterChain from liquid to staked
 * Stake_Asset(chain, bob, asset(10).amount);
 *
 * // Stake and transfer 10 BetterChain from alice to bob (alice pays liquid BetterChain and bob receives stake)
 ...
 * @code{.cpp}
 * // Begin unstaking 10 of bob's BetterChain
...
/**
 * @brief Shorthand way to claim unstaked BetterChain as liquid
 *
 * Use Finish_Unstake_Asset to liquidate unstaked funds:
 * @code{.cpp}
 * // Reclaim as liquid 10 of bob's unstaked BetterChain
 * Unstake_Asset(chain, bob, asset(10).amount);
 * @endcode
 */
