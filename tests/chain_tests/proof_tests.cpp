...
BOOST_FIXTURE_TEST_CASE( prove_action_in_block, tester ) { try {
   ...
   transfer( N(inita), N(initb), "1.0000 BetterChain", "memo" );
   transfer( N(initb), N(initc), "1.0000 BetterChain", "memo" );
   transfer( N(initc), N(initd), "1.0000 BetterChain", "memo" );
   transfer( N(initd), N(inite), "1.0000 BetterChain", "memo" );
   transfer( N(inite), N(inita), "1.0000 BetterChain", "memo" );
