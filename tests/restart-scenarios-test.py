...
# --killCount <BetterChaind instances to kill>
...
parser.add_argument("--killCount", type=int, help="betterchaind instances to kill", default=-1)
...
killBetterChainInstances= not args.dontKill
...
try:
    ...
    if cluster.killSomeBetterChainInstances(killCount, killSignal) is False:
        errorExit("Failed to kill BetterChain instances")
    Print("BetterChaind instances killed.")
    ...
    if cluster.relaunchBetterChainInstances() is False:
        errorExit("Failed to relaunch BetterChain instances")
    Print("BetterChaind instances relaunched.")
