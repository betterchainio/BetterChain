...
namespace native {
  /**
    @defgroup betterchaincontract BetterChain Contract
    @brief Documents the interface to the BetterChain currency contract
    @ingroup contracts
    @{
  */
   ...
   /**
    *   @class betterchain
    *   @brief A *native* currency contract implemented with account named `betterchain`
    *   @ingroup contracts
    *
    *   @details The BetterChain contract is a *native* currency contract implemented with account named `betterchain`. This contract enables
    *   users to transfer BetterChain tokens to each other. This contract is designed to work the @ref stakedcontract and
    *   @ref systemcontract when creating new accounts, claiming staked BetterChain.
    */
   struct betterchain : public contract {
      ...
      access to the `betterchain` scope which means that multiple transfers can execute in parallel
      ...
      other contracts are notified anytime BetterChain tokens are transferred.

      */
      void transfer (
         account_name from,  ///< account from which BetterChain will be withdrawn
         account_name to,    ///< account to receive BetterChain, may not be same as `from`
