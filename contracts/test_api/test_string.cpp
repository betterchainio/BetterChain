...
unsigned int test_string::construct_with_data() {
  ...
  betterchain::string str1(data, size, false);
  ...
  betterchain::string str2(data, 0, false);
...
unsigned int test_string::construct_with_data_partially() {
  ...
  betterchain::string str(data + offset, substr_size, false);
...
unsigned int test_string::construct_with_data_copied() {
  ...
  betterchain::string str1(data, size, true);
  ...
  betterchain::string str2(data, 0, true);
...
unsigned int test_string::index_operator() {
  ...
  betterchain::string str(data, size, false);
...
unsigned int test_string::substring() {
  ...
  size_t substr_size = 5;
  size_t offset = 2;
  betterchain::string substr = str.substr(offset, substr_size, false);
...
unsigned int test_string::concatenation_null_terminated() {
  ...
  betterchain::string str1(data1, size1, false);

  char data2[] = "klmnoppqrst";
  size_t size2 = sizeof(data2)/sizeof(char);
  betterchain::string str2(data2, size2, false);
...
unsigned int test_string::comparison_operator() {
  ...
  betterchain::string str3(data3, size3, false);

  char data4[] = "aaaaaaaaaaaaaaa";
  size_t size4 = sizeof(data4)/sizeof(char);
  betterchain::string str4(data4, size4, false);

  char data5[] = "你好";
  size_t size5 = sizeof(data5)/sizeof(char);
  betterchain::string str5(data5, size5, false);

  char data6[] = "你好嗎？";
  size_t size6 = sizeof(data6)/sizeof(char);
  betterchain::string str6(data6, size6, false);

  char data7[] = {'a', 'b', 'c', 'd', 'e'};
  size_t size7 = sizeof(data7)/sizeof(char);
  betterchain::string str7(data7, size7, false);

  char data8[] = {'a', 'b', 'c'};
  size_t size8 = sizeof(data8)/sizeof(char);
  betterchain::string str8(data8, size8, false);
...
unsigned int test_string::valid_utf8() {
  ...
  betterchain::string valid_greek_str(greek_str_data, greek_str_size, false);
  ...
  betterchain::string valid_chinese_str1(chinese_str_data1, chinese_str_size1, false);
  ...
  betterchain::string valid_chinese_str2(chinese_str_data2, chinese_str_size2, false);
...
unsigned int test_string::invalid_utf8() {
  ...
  betterchain::string invalid_chinese_str(chinese_str_data, 5, false);
...
unsigned int test_string::string_literal() {
  ...
  betterchain::string str = "abcdefghij";
