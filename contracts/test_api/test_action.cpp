...
//      betterchain::require_recipient( N(acc1) );
//      betterchain::require_recipient( N(acc2) );
//      betterchain::require_recipient( N(acc1), N(acc2) );
...
//   betterchain::require_auth( N(acc3) );
//   betterchain::require_auth( N(acc4) );
//   return WASM_TEST_PASS;
//}
