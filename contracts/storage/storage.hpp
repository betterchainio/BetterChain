...
namespace TOKEN_NAME {
    ...
    */
    typedef betterchain::token<uint64_t, N(storage)> storage_tokens;
   ...
   **/
   using accounts = betterchain::table<N(storage),N(storage),N(account),account,uint64_t>;
