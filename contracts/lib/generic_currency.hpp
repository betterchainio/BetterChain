   ...
   class generic_currency {
      public:
          ...
          ACTION( code, issue ) {
             ...
             BetterChainLIB_SERIALIZE( issue, (to)(quantity) )
          };
          ...
          struct transfer_memo : public transfer {
             ...
             BetterChainLIB_SERIALIZE_DERIVED( transfer_memo, transfer, (memo) )
          };
          ...
          struct account {
             ...
             BetterChainLIB_SERIALIZE( account, (symbol)(balance) )
          };
          ...
          struct currency_stats {
             ...
             BetterChainLIB_SERIALIZE( currency_stats, (symbol)(supply) )
          };
         ...
         static void apply( account_name c, action_name act) {
            betterchain::dispatch<generic_currency, transfer_memo, issue>(c,act);
         }
   };
