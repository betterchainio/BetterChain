...
extern "C" {
    ...
    *
    *
    * A BetterChain action has the following abstract structure:
    *
    * ```
    *   struct action {
    ...
    * print(Name(code)); // Output: betterchain
    *
    * assert(Name(current_receiver()) === "betterchain", "This action expects to be received by betterchain"); // Do nothing
