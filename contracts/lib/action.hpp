...
namespace betterchain {
   ...
   struct permission_level {
      ...
      BetterChainLIB_SERIALIZE( permission_level, (actor)(permission) )
   };
   ...
   struct action {
      ...
      BetterChainLIB_SERIALIZE( action, (account)(name)(authorization)(data) )
...
#define ACTION( CODE, NAME ) struct NAME : ::betterchain::action_meta<CODE, ::betterchain::string_to_name(#NAME) >
