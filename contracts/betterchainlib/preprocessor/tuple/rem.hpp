...
# include <lib/preprocessor/facilities/expand.hpp>
# include <lib/preprocessor/facilities/overload.hpp>
# include <lib/preprocessor/tuple/detail/is_single_return.hpp>
#
# /* BOOST_PP_REM */
#
