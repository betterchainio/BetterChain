...
namespace betterchain {
  ...
  */
  ...
  struct token {
    /**
    * Type of the currency (e.g. betterchain) represented as an unsigned 64 bit integer
  ...
  *  Example:
  *  @code
  *  typedef betterchain::token<uint64_t, N(MyBaseToken)> MyBaseToken;
  *  typedef betterchain::token<uint64_t, N(MyQuoteToken)> MyQuoteToken;
  ...
  */
  ...
  private:
    ...
    */
    betterchain::uint128 base_per_quote;
  };
