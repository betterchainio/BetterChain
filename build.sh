...
##########################################################################
# This is BetterChain bootstrapper script for Linux and OS X.
# This file was downloaded from https://github.com/betterchainio/betterchain
