...
using betterchain::chain::contracts::genesis_state_type;
...
"// BETTERCHAIN_EGENESIS_JSON to specify an embedded genesis state.          //\n"
"//                                                                  //\n"
;

// hack:  import create_example_genesis() even though it's a way, way
// specific internal detail
namespace betterchain { namespace app { namespace detail {
genesis_state_type create_example_genesis();
} } } // betterchain::app::detail
...
{ try {
   int main_return = 0;
   boost::program_options::options_description cli_options("BetterChain Chain Identifier");
