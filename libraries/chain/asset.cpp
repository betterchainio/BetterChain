...
price price::max( asset_symbol base, asset_symbol quote ) { return asset( share_type(BETTERCHAIN_MAX_SHARE_SUPPLY), base ) / asset( share_type(1), quote); }
price price::min( asset_symbol base, asset_symbol quote ) { return asset( 1, base ) / asset( BETTERCHAIN_MAX_SHARE_SUPPLY, quote); }
