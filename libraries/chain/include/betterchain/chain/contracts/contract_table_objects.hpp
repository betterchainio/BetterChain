...
#include <betterchain/chain/multi_index_includes.hpp>
...
CHAINBASE_SET_INDEX_TYPE(betterchain::chain::contracts::table_id_object, betterchain::chain::contracts::table_id_multi_index)
CHAINBASE_SET_INDEX_TYPE(betterchain::chain::contracts::key_value_object, betterchain::chain::contracts::key_value_index)
CHAINBASE_SET_INDEX_TYPE(betterchain::chain::contracts::keystr_value_object, betterchain::chain::contracts::keystr_value_index)
CHAINBASE_SET_INDEX_TYPE(betterchain::chain::contracts::key128x128_value_object, betterchain::chain::contracts::key128x128_value_index)
CHAINBASE_SET_INDEX_TYPE(betterchain::chain::contracts::key64x64x64_value_object, betterchain::chain::contracts::key64x64x64_value_index)

FC_REFLECT(betterchain::chain::contracts::table_id_object, (id)(scope)(code)(table) )
FC_REFLECT(betterchain::chain::contracts::key_value_object, (id)(t_id)(primary_key)(value) )
FC_REFLECT(betterchain::chain::contracts::keystr_value_object, (id)(t_id)(primary_key)(value) )
FC_REFLECT(betterchain::chain::contracts::key128x128_value_object, (id)(t_id)(primary_key)(secondary_key)(value) )
FC_REFLECT(betterchain::chain::contracts::key64x64x64_value_object, (id)(t_id)(primary_key)(secondary_key)(tertiary_key)(value) )