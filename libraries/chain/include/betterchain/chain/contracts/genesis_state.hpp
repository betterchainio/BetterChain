...
#include <betterchain/chain/immutable_chain_parameters.hpp>
...
FC_REFLECT(betterchain::chain::contracts::genesis_state_type::initial_account_type,
           (name)(staking_balance)(liquid_balance)(owner_key)(active_key))

FC_REFLECT(betterchain::chain::contracts::genesis_state_type::initial_producer_type, (owner_name)(block_signing_key))

FC_REFLECT(betterchain::chain::contracts::genesis_state_type,
