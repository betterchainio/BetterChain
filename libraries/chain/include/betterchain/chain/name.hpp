...
#define N(X) betterchain::chain::string_to_name(#X)
...
namespace fc {
  class variant;
  void to_variant(const betterchain::chain::name& c, fc::variant& v);
  void from_variant(const fc::variant& v, betterchain::chain::name& check);
} // fc


FC_REFLECT( betterchain::chain::name, (value) )
