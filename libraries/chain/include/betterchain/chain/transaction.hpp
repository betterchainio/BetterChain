...
namespace betterchain { namespace chain {
    ...
    *  In the context of betterchain, every action is dispatched to the handler defined
...
FC_REFLECT( betterchain::chain::permission_level, (actor)(permission) )
FC_REFLECT( betterchain::chain::action, (account)(name)(authorization)(data) )
FC_REFLECT( betterchain::chain::transaction_header, (expiration)(region)(ref_block_num)(ref_block_prefix) )
FC_REFLECT_DERIVED( betterchain::chain::transaction, (betterchain::chain::transaction_header), (actions) )
FC_REFLECT_DERIVED( betterchain::chain::signed_transaction, (betterchain::chain::transaction), (signatures) )
FC_REFLECT_DERIVED( betterchain::chain::deferred_transaction, (betterchain::chain::transaction), (sender_id)(sender)(execute_after) )
FC_REFLECT_ENUM( betterchain::chain::data_access_info::access_type, (read)(write))
FC_REFLECT( betterchain::chain::data_access_info, (type)(scope)(sequence))
FC_REFLECT( betterchain::chain::action_trace, (receiver)(act)(console)(region_id)(cycle_index)(data_access) )
FC_REFLECT( betterchain::chain::transaction_receipt, (status)(id))
FC_REFLECT_ENUM( betterchain::chain::transaction_receipt::status_enum, (executed)(soft_fail)(hard_fail))
FC_REFLECT_DERIVED( betterchain::chain::transaction_trace, (betterchain::chain::transaction_receipt), (action_traces)(deferred_transactions) )
