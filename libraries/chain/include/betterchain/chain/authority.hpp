...
FC_REFLECT(betterchain::chain::permission_level_weight, (permission)(weight) )
FC_REFLECT(betterchain::chain::key_weight, (key)(weight) )
FC_REFLECT(betterchain::chain::authority, (threshold)(accounts)(keys))
FC_REFLECT(betterchain::chain::shared_authority, (threshold)(accounts)(keys))
