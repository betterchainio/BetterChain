...
CHAINBASE_SET_INDEX_TYPE(betterchain::chain::action_permission_object, betterchain::chain::action_permission_index)

FC_REFLECT(betterchain::chain::action_permission_object, (id)(owner)(owner_permission)(scope_permission) )
