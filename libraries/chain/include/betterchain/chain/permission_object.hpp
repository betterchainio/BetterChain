...
CHAINBASE_SET_INDEX_TYPE(betterchain::chain::permission_object, betterchain::chain::permission_index)
CHAINBASE_SET_INDEX_TYPE(betterchain::chain::permission_usage_object, betterchain::chain::permission_usage_index)

FC_REFLECT(chainbase::oid<betterchain::chain::permission_object>, (_id))
FC_REFLECT(betterchain::chain::permission_object, (id)(owner)(parent)(name)(auth))

FC_REFLECT(chainbase::oid<betterchain::chain::permission_usage_object>, (_id))
FC_REFLECT(betterchain::chain::permission_usage_object, (id)(account)(permission)(last_used))
