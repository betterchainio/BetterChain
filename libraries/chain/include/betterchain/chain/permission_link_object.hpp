...
CHAINBASE_SET_INDEX_TYPE(betterchain::chain::permission_link_object, betterchain::chain::permission_link_index)

FC_REFLECT(betterchain::chain::permission_link_object, (id)(account)(code)(message_type)(required_permission))
