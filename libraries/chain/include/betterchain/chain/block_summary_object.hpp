...
CHAINBASE_SET_INDEX_TYPE(betterchain::chain::block_summary_object, betterchain::chain::block_summary_multi_index)

FC_REFLECT( betterchain::chain::block_summary_object, (block_id) )
