...
CHAINBASE_SET_INDEX_TYPE(betterchain::chain::bandwidth_usage_object, betterchain::chain::bandwidth_usage_index)
CHAINBASE_SET_INDEX_TYPE(betterchain::chain::compute_usage_object, betterchain::chain::compute_usage_index)
