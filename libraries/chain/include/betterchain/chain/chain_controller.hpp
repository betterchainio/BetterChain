...
namespace betterchain { namespace chain {
   ...
   class chain_controller : public boost::noncopyable {
      ...
      /**
          ...
          *
          * Passing slot_num == 0 returns BETTERCHAIN_NULL_PRODUCER
          */
      ...
      private:
         ...
         try {
            BETTERCHAIN_ASSERT(trx.messages.size() > 0, transaction_exception, "A transaction must have at least one message");
