...
/// betterchain with 8 digits of precision
...
#define BETTERCHAIN_MAX_SHARE_SUPPLY   int64_t(1'000'000'000'000'000ll)
...
struct asset
{
   asset(share_type a = 0, asset_symbol id = BETTERCHAIN_SYMBOL)
      :amount(a),symbol(id){}
...
namespace fc {
inline void to_variant(const betterchain::chain::asset& var, fc::variant& vo) { vo = var.to_string(); }
inline void from_variant(const fc::variant& var, betterchain::chain::asset& vo) {
   vo = betterchain::chain::asset::from_string(var.get_string());
}
}

FC_REFLECT(betterchain::chain::asset, (amount)(symbol))
FC_REFLECT(betterchain::chain::price, (base)(quote))
