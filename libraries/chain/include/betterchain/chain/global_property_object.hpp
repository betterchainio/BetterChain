...
#include <betterchain/chain/incremental_merkle.hpp>
...
CHAINBASE_SET_INDEX_TYPE(betterchain::chain::global_property_object, betterchain::chain::global_property_multi_index)
CHAINBASE_SET_INDEX_TYPE(betterchain::chain::dynamic_global_property_object,
                         betterchain::chain::dynamic_global_property_multi_index)

FC_REFLECT(betterchain::chain::dynamic_global_property_object,
           (head_block_number)
           (head_block_id)
           (time)
           (current_producer)
...
FC_REFLECT(betterchain::chain::global_property_object,
           (configuration)
           (active_producers)
          )
