...
int main( int argc, char** argv ) {
   try {
      ...
      /*
      auto private_key_default = std::make_pair(betterchain::chain::public_key_type(default_priv_key.get_public_key()),
                                                betterchain::utilities::key_to_wif(default_priv_key));
                                                */
